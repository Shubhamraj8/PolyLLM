...
class CostTracker:
    ...
    async def record(self, provider: str, model: str, prompt_tokens: int, completion_tokens: int) -> float:
        ...
        tokens_used_counter.labels(provider=provider, model=model, type="completion").inc(completion_tokens)
